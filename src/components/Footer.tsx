        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://github.com/PoRiFiRo123/gitread" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-600 hover:text-blue-600 font-medium transition-colors flex items-center gap-2">
